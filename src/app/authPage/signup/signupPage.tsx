...
export default function SignInPage({ setShowReg }: SignInPageProps) {
  return (
    <section className="flex items-start md:items-center justify-center h-full p-4 bg-black/10">
      <div className="relative flex flex-col md:flex-row w-full md:max-w-4xl shadow-lg md:rounded-lg overflow-hidden ">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center p-6 md:p-12 bg-orange-50 gap-4 relative">
          ...
          <div className="space-y-3">
            <a
              ...
              className="flex items-center justify-center gap-3 bg-orange-500 text-white px-5 py-2 rounded-lg w-full"
            >
              <FaUserGraduate /> Continue as a teacher <FaChevronRight />
            </a>
            <a
              href="/student/register"
              className="flex items-center justify-center gap-3 bg-orange-500 text-white px-5 py-2 rounded-lg w-full"
            >
              <FaUser /> Continue as a student <FaChevronRight />
            </a>
          </div>
</div>
        {/* Close button */}
